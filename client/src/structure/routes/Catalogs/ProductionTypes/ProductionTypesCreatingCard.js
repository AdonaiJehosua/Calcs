                                    ...
                                    <CardContent>
                                        ...
                                        <Container>
                                            <TextField
                                                ...
                                                id="productionType"
                                                type="text"
                                                className={`yellow-input ${errors.productionType && touched.productionType && errors.productionType}`}
                                                name="productionType"
                                            ...
                                            <TextField
                                                ...
                                                id="description"
                                                type="text"
                                                className={`yellow-input ${errors.description && touched.description && errors.description}`}
                                                name="description"
