...
// Метод makeMutation в свою очередь, принимает: 1. Объект переменных для мутации *ОБЯЗАТЕЛЬНО*. 2 - собственно, объект значений формика *ОПЦИОНАЛЬНО*. 3 - массив представленных строками идентификаторов значений, которые должны обнуляться в инпутах при успешном создании документа *ОПЦИОНАЛЬНО* - на случай, если обнулять нужно не все значения формы.
